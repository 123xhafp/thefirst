    ...
    return(
        <div className="relative border  top-[80px] left-[280px] w-[1020px] h-[1120px]">
            <div className="mt-[32px] ml-[32px] h-[20px] mb-[32px] transition-colors text-base-content text-sm hover:text-primary" >
                ...
                <div className="absolute ml-[74px] hover:text-yellow-400 transition-colors"><a href="http://localhost:3000/newest">Newest</a></div>  
                <div className="absolute ml-[136px] mt-[3.5px]"><IoIosArrowForward /></div>
                <div className="absolute ml-[162px] text-yellow-400">Suno AI Songs</div>
            </div>
            ...
            <div className="ml-[32px] w-[315px] mb-[25px] h-[40px] flex bg-gray-100 border border-transparent rounded-[8px]">
                ...
                <div className=" mt-[3px]  rounded-[8px] pl-[12px] pt-[5.5px] text-[14.5px] h-[33px] w-[130px] ml-[4px] bg-yellow-400"><a href="http://localhost:3000/newest/suno-ai-songs">Suno AI Songs</a></div>

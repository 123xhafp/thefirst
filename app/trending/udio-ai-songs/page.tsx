    ...
    return(
        <div className="relative border  top-[80px] left-[280px] w-[1020px] h-[1120px]">
            <div className="mt-[32px] ml-[32px] h-[20px] mb-[32px] transition-colors text-base-content text-sm hover:text-primary" >
                ...
                <div className="absolute ml-[168px] text-yellow-400">udio-ai-songs</div>  
            </div>
            ...
            <div className="ml-[32px] w-[315px] mb-[25px] h-[40px] flex bg-gray-100 border border-transparent rounded-[8px]">
                ...
                <div className=" mt-[3px]   pl-[12px] pt-[5.5px] text-[14.5px] h-[33px] w-[130px] ml-[4px]"><a href="http://localhost:3000/trending/suno-ai-songs">Suno AI Songs</a></div>
                <div className="mt-[3px] border  rounded-[8px] pl-[11.5px] pt-[5.5px] text-[14.5px] h-[33px] w-[120px] ml-[4px]  bg-yellow-400"><a href="http://localhost:3000/trending/udio-ai-songs">Udio AI Songs</a></div>
            </div>
